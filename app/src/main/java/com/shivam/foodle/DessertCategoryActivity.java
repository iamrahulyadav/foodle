...
public class DessertCategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar=(Toolbar)findViewById(R.id.dessertCategoryActivityToolbar);
        ...
        recipe=db.getAllRecipeByCategory("Dessert");
        //read data category wise and store it in recipe

        recyclerView=(RecyclerView)findViewById(R.id.dessertCategoryRecyclerView);
        recyclerView.setLayoutManager(new LinearLayoutManager(getBaseContext()));
        recyclerView.setAdapter(new DessertCategoryActivity.RecyclerViewAdapter(recipe));
    ...
    public class RecyclerViewAdapter extends RecyclerView.Adapter<DessertCategoryActivity.RecyclerViewHolder>{
        ...
        @Override
        public DessertCategoryActivity.RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view= LayoutInflater.from(getBaseContext()).inflate(R.layout.home_stream_card_view,parent,false);
            return new DessertCategoryActivity.RecyclerViewHolder(view);
        }

        @Override
        public void onBindViewHolder(DessertCategoryActivity.RecyclerViewHolder holder, int position) {
            if(recipe!=null) {
