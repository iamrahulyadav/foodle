...
public class MaindishCategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maindish_category);

        toolbar=(Toolbar)findViewById(R.id.maindishCategoryActivityToolbar);
        ...
        if(getSupportActionBar()!=null){
            ...
            getSupportActionBar().setTitle("MainDish");
            toolbar.setTitleTextColor(0xFFFFFFFF);
        }

        DatabaseHandler db=new DatabaseHandler(this);
        recipe=new ArrayList<RecipeModel>();
        recipe=db.getAllRecipeByCategory("MainDish");
        //read data category wise and store it in recipe

        recyclerView=(RecyclerView)findViewById(R.id.maindishCategoryRecyclerView);
        recyclerView.setLayoutManager(new LinearLayoutManager(getBaseContext()));
        recyclerView.setAdapter(new MaindishCategoryActivity.RecyclerViewAdapter(recipe));
    ...
    public class RecyclerViewAdapter extends RecyclerView.Adapter<MaindishCategoryActivity.RecyclerViewHolder>{
        ...
        @Override
        public MaindishCategoryActivity.RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view= LayoutInflater.from(getBaseContext()).inflate(R.layout.home_stream_card_view,parent,false);
            return new MaindishCategoryActivity.RecyclerViewHolder(view);
        }

        @Override
        public void onBindViewHolder(MaindishCategoryActivity.RecyclerViewHolder holder, int position) {
            if(recipe!=null) {
