...
public class BreakfastCategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar=(Toolbar)findViewById(R.id.breakfastCategoryActivityToolbar);
        ...
        recipe=db.getAllRecipeByCategory("Breakfast");

        recyclerView=(RecyclerView)findViewById(R.id.breakfastCategoryRecyclerView);
        recyclerView.setLayoutManager(new LinearLayoutManager(getBaseContext()));
        recyclerView.setAdapter(new BreakfastCategoryActivity.RecyclerViewAdapter(recipe));
    ...
    public class RecyclerViewAdapter extends RecyclerView.Adapter<BreakfastCategoryActivity.RecyclerViewHolder>{
        ...
        @Override
        public BreakfastCategoryActivity.RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view= LayoutInflater.from(getBaseContext()).inflate(R.layout.home_stream_card_view,parent,false);
            return new BreakfastCategoryActivity.RecyclerViewHolder(view);
        }

        @Override
        public void onBindViewHolder(BreakfastCategoryActivity.RecyclerViewHolder holder, int position) {
            if(recipe!=null) {
