...
public class AppetizersCategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_appetizers_category);

        toolbar=(Toolbar)findViewById(R.id.appetizersCategoryActivityToolbar);
        ...
        recipe=db.getAllRecipeByCategory("Appetizers");

        recyclerView=(RecyclerView)findViewById(R.id.appetizersCategoryRecyclerView);
        recyclerView.setLayoutManager(new LinearLayoutManager(getBaseContext()));
        recyclerView.setAdapter(new AppetizersCategoryActivity.RecyclerViewAdapter(recipe));
    ...
    public class RecyclerViewAdapter extends RecyclerView.Adapter<AppetizersCategoryActivity.RecyclerViewHolder>{
        ...
        @Override
        public AppetizersCategoryActivity.RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view= LayoutInflater.from(getBaseContext()).inflate(R.layout.home_stream_card_view,parent,false);
            return new AppetizersCategoryActivity.RecyclerViewHolder(view);
        }

        @Override
        public void onBindViewHolder(AppetizersCategoryActivity.RecyclerViewHolder holder, int position) {
            if(recipe!=null) {
