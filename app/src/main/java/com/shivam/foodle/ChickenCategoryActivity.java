...
public class ChickenCategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar=(Toolbar)findViewById(R.id.chickenCategoryActivityToolbar);
        ...
        recipe=db.getAllRecipeByCategory("Chicken");
        //read data category wise and store it in recipe

        recyclerView=(RecyclerView)findViewById(R.id.chickenCategoryRecyclerView);
        recyclerView.setLayoutManager(new LinearLayoutManager(getBaseContext()));
        recyclerView.setAdapter(new ChickenCategoryActivity.RecyclerViewAdapter(recipe));
    ...
    public class RecyclerViewAdapter extends RecyclerView.Adapter<ChickenCategoryActivity.RecyclerViewHolder>{
        ...
        @Override
        public ChickenCategoryActivity.RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view= LayoutInflater.from(getBaseContext()).inflate(R.layout.home_stream_card_view,parent,false);
            return new ChickenCategoryActivity.RecyclerViewHolder(view);
        }

        @Override
        public void onBindViewHolder(ChickenCategoryActivity.RecyclerViewHolder holder, int position) {
            if(recipe!=null) {
